...
// import sasiru from 'sasiru-dp.png';
        ...
        <div className={classNames(styles.root, className)}>
            ...
            <div className={styles.area}>
                <div className={classNames('team', styles.team)}>
                    ...
                    <div className={classNames('member', styles.member)}>
                        <img src="https://picsum.photos/150/150" alt="Member photo Sasiru" />
            ...
            <div className={styles['after-statement']}>
                <p className="afterstatement-text">
                    <i>
                        ...
                        varius felis, quis faucibus dolor hendrerit vel. Pellentesque aliquet elit
                        elit, ut gravida justo rhoncus in.
                    </i>
                </p>
            </div>
            <Footer />
