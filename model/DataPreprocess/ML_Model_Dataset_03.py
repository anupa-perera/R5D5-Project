...
WORKING_DIR1  = "C:/Users/ASUS/Documents/GitHub/R5D5-Project/model/DataPreprocess/Datasets/NBA Player Stats - Playoffs.csv"
...
df1.to_csv("ML_Model_Dataset_01/complete_data_model_NBA_Player_Stats_Playoffs.csv", index=False)
X_train.to_csv("ML_Model_Dataset_01/X_train03.csv", index=False)
X_test.to_csv("ML_Model_Dataset_01/X_test03.csv", index=False)
y_train.to_csv("ML_Model_Dataset_01/y_train03.csv", index=False)
y_test.to_csv("ML_Model_Dataset_01/y_test03.csv", index=False)
